...
from avqe_qnp_qrisp_fast import self_verifying_AVQE_qrisp_fast
import numpy as np
...
def run_qrisp_fast_2qubit_example():
    print("==========================================")
    print("  Qrisp: 2-Qubit Grid (Native Execution)  ")
    print("==========================================")
    ...
    self_verifying_AVQE_qrisp_fast(
        H_i=Hi_2q,
        H_f=Hf_2q,
        P_strings=P_strings,
        params_0=params_0,
        ...
        delta_C=0.40,
        lr=0.08,
        name="2-qubit-qrisp-fast-avqe",
        live_plot=True,     # Interactive live tracking enabled
        track_exact=True    # Calculates ground energy baseline and infidelity
    )

def run_qrisp_fast_4qubit_example():
    print("==========================================")
    print("  Qrisp: 4-Qubit TFIM (Native Execution)  ")
    print("==========================================")
    ...
    self_verifying_AVQE_qrisp_fast(
        ...
        delta_C=0.4,
        lr=0.08,
        name="4-qubit-qrisp-fast-tfim",
        live_plot=True,     # Toggle real-time plotting
        track_exact=True    # Toggle exact ground-state diagonalization
    )


def run_qrisp_fast_10qubit_example():
    print("==========================================")
    print("  Qrisp: 10-Qubit 2x5 Grid (Native Run)   ")
    print("==========================================")
...
if __name__ == "__main__":
    ...
    run_qrisp_fast_2qubit_example()
    run_qrisp_fast_4qubit_example()
    run_qrisp_fast_10qubit_example()